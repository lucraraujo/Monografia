...
%% Informações rápidas podem ser acessadas em 
...
\setbeamercolor{block body}{bg=gray, fg=darkgray}	%Cor do texto (bg= fundo; 
%fg=texto)
...
\begin{minipage}{1\linewidth}
  ...
  \begin{tabular}{cc}
    ...
    &
    \begin{tabular}{c}
      \textbf{Universidade do Brasil} \\ \textbf{Faculdade de Arquitetura da 
      Informação}
    \end{tabular}
  \end{tabular}
\end{minipage}
